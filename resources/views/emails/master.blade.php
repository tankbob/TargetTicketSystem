...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            .buttonContent a:active{color:#045EC4;}
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tbody><tr>
                                                                    <td valign="top" align="center" class="imageContent">
                                                                        ...
                                                                        @else
                                                                        <img src="{{ url('images/logo.svg') }}" style="max-width:500px;max-height:100px;display:block;margin:0 auto;padding:10px 0;" alt="" title="">
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                    	...
                                    	<tr style="padding-top:0;">
                                        	<td align="center" valign="top">
                                            	<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
                                                	<tr>
                                                    	<td align="center" valign="top" width="500" class="flexibleContainerCell">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #aaaaaa;">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                        <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="@yield('button_url')" target="_blank">@yield('button_text')</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
